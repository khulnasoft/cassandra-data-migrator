...
## [4.3.4] - 2024-07-31
- Use `spark.cdm.schema.origin.keyspaceTable` when `spark.cdm.schema.target.keyspaceTable` is missing. Fixes [bug introduced in prior version](https://github.com/khulnasoft/cassandra-data-migrator/issues/284).
...
## [4.3.1] - 2024-07-19
- Fixed a validation run [bug](https://github.com/khulnasoft/cassandra-data-migrator/issues/266) that sometimes did not report a failed token-range
