 ...
 */
package com.khulnasoft.cdm.data;
...
import com.khulnasoft.dse.driver.api.core.type.DseDataTypes;
...
import com.khulnasoft.oss.driver.api.core.type.ListType;
import com.khulnasoft.oss.driver.api.core.type.MapType;
import com.khulnasoft.oss.driver.api.core.type.SetType;
import com.khulnasoft.oss.driver.api.core.type.TupleType;
...
public class CqlData {
    ...
    static {
        ...
        primitiveDataTypeToJavaClassMap.put(DataTypes.DURATION,
                com.khulnasoft.oss.driver.api.core.data.CqlDuration.class);
        primitiveDataTypeToJavaClassMap.put(DseDataTypes.POLYGON,
                com.khulnasoft.dse.driver.api.core.data.geometry.Polygon.class);
        primitiveDataTypeToJavaClassMap.put(DseDataTypes.POINT,
                com.khulnasoft.dse.driver.api.core.data.geometry.Point.class);
        primitiveDataTypeToJavaClassMap.put(DseDataTypes.LINE_STRING,
                com.khulnasoft.dse.driver.api.core.data.geometry.LineString.class);
        primitiveDataTypeToJavaClassMap.put(DseDataTypes.DATE_RANGE,
                com.khulnasoft.dse.driver.api.core.data.time.DateRange.class);
    }
    ...
    public static Class getBindClass(DataType dataType) {
        ...
        if (dataType instanceof UserDefinedType)
            return com.khulnasoft.oss.driver.api.core.data.UdtValue.class;
        if (dataType instanceof TupleType)
            return com.khulnasoft.oss.driver.api.core.data.TupleValue.class;
        if (dataType instanceof VectorType)
            return com.khulnasoft.oss.driver.api.core.data.CqlVector.class;
